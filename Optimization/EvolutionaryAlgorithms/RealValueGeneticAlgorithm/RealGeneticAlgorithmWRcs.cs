...
{
    public class RealGeneticAlgorithmWRcs : EvolutionaryAlgorithm<RealGeneticAlgorithmParametersWRcs>
    {
        ...
        protected override void NextIteration()
        {
            ...
            {
                int chooseIndex = RandomEngine.Instance.GenerateIntsUniformlyDistributed(0, Parameters.SizeOfTrialPopulation);
